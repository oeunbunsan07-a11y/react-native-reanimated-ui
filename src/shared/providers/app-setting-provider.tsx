...
// 1. Define Types for the Player Settings Configurations
...
interface AppSettingsContextType extends AppSettings {
    ...
    toggleDownloadOverWifi: () => Promise<void>;
    toggleDataSaver: () => Promise<void>;
    isLoadingSettings: boolean;
}

const STORAGE_KEY = '@music_app_user_settings';

// Default initial state values
const defaultSettings: AppSettings = {
    theme: 'dark', // Music players typically default to modern dark UI formats
    audioQuality: 'high',
